...
if(isset($_POST['submit2'])){
    ...
    if($test_type == "Haematological Test" && $category != NULL){
        setcookie("category" , $category , time() + (86400 * 2) , "/") ;
        header("location:first_third_test.php") ;
    }
    else if($test_type != NULL && $category != NULL){
        setcookie("category" , $category , time() + (86400 * 2) , "/") ;
        header("location:first_third_test.php") ;
    }
    else
...
<body>
    ...
    <section class="second_test_container" id="second_test_cont_id">
        <form action="first_test.php" method="post" class="second_test_inside_1">
                ...
                <div class="second_test_input_field_type">
                    <label>
                        <input type="checkbox" name="Fat_test" id="Fat_test_1" class="fat_test_field_1"
                            value="Haematological Test" checked onclick="clickfunc(this)">
                        Haematological Test
                    </label>
                    <label>
                        <input type="checkbox" name="Fat_test" id="Fat_test_2" class="fat_test_field_2"
                            value="Biochemical Test" onclick="clickfunc(this)">
                        Biochemical Test
                    </label>
                    <label>
                        <input type="checkbox" name="Fat_test" id="Fat_test_3" class="fat_test_field_3"
                            value="Vitamins Test" onclick="clickfunc(this)">
                        Vitamins Test
                    </label>
                </div>
